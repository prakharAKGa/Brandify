...
class HuggingFaceService {
  static const String _apiKey = "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"; // Replace with your actual API key
  static const String _apiUrl = "https://api-inference.huggingface.co/models/tiiuae/falcon-7b-instruct";

  static Future<List<String>> generateCaptions(String category, String keywords) async {
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          "inputs": "Generate 5 catchy captions for a $category using these keywords: $keywords. List each caption on a new line.",
          "parameters": {
            "max_length": 200,
