import 'package:brandify/screens/post_creation/post/post_output_screen.dart';
...
class _PostCreationScreenState extends State<PostCreationScreen> {
  String selectedPostType = 'Hiring post';
  ...
  Widget build(BuildContext context) {
            ...
            child: Column(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text(
                    'Tell more about posts to create',
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PostOutputScreen(
